...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <!-- Title Page-->
    <title>Motivos de Não Agendamento - Call Center Integra</title>
    ...
    <a href="http://localhost:8001/">
        ...
        <div class="wrapper wrapper--w680">
            ...
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Motivos de Não Agendamento - Call Center Integra</h2>
                    <?php
                    ...
                    <form id="contactForm" method="POST" action="processa.php">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="nome_beneficiario" >
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Data da Ligação</label>
                                    <input class="input--style-4" type="text" placeholder="Ex: 01/01/2020" name="data_ligacao">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <label class="label">Motivo Não Agendamento</label>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="motivo_nao_agendamento">
                                    <option disabled="disabled" selected="selected">Selecione o Motivo:</option>
                                    <option value="Não Há Vagas">Não Há Vagas</option>
                                    <option value="Não Aceitou Outro Especialista">Não Aceitou Outro Especialista</option>
                                    <option value="Tempo Novo de Espera">Tempo Novo de Espera</option>
                                    <option value="Não Aceitou Telemedicina">Não Aceitou Telemedicina</option>
